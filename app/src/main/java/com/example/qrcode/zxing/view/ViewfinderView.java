...
package com.example.qrcode.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		cornerColor = getResources().getColor(getResources().getIdentifier("colorPrimaryDark", "color", context.getPackageName()));
		maskColor = getResources().getColor(getResources().getIdentifier("viewfinder_mask", "color", context.getPackageName()));
		resultColor = getResources().getColor(getResources().getIdentifier("result_view", "color", context.getPackageName()));
		frameColor = getResources().getColor(getResources().getIdentifier("viewfinder_frame", "color", context.getPackageName()));
		laserColor = getResources().getColor(getResources().getIdentifier("viewfinder_laser", "color", context.getPackageName()));
		resultPointColor = getResources().getColor(getResources().getIdentifier("possible_result_points", "color", context.getPackageName()));
		scannerAlpha = 0;
